...
. ./cmd_zge.sh ## You'll want to change cmd.sh to something that will work on your system.
...
wsj0=/mnt/psvr/SpeechData/English/WSJ0
wsj1=/mnt/psvr/SpeechData/English/WSJ1
